...
const AioCommand: typeof Command = require('@adobe/aio-cli-plugin-runtime/src/commands/runtime/trigger/update')

export default class TriggerUpdate extends Command {
  async run () {
