...
// Test whether an item is a dictionary.  In practice this means its basic type is object and it isn't an array.
// Note that the typeof null is 'object' but null isn't an array so the test seems solid enough.
